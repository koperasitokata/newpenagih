  ...
  const handleShare = async () => {
    ...
    if (element) {
      try {
        ...
        await Promise.all(
          Array.from(images).map((elementImg) => {
        ...
        const filename = `STRUK-${nasabah.nama.replace(
          /\s+/g,
          '-'
        )}-${Date.now()}.png`;
        ...
        if (!blob) {
          throw new Error('Blob gagal dibuat');
        }
        ...
        if (canUseNativeShare) {
          try {
            await navigator.share({
              ...
              text:
                `Struk Pembayaran Angsuran ${nasabah.nama}` +
            ...
            console.log(
              'Native share gagal, fallback ke download',
              shareErr
            );
          }
        }
        ...
        alert(
          'Gagal memproses gambar struk. Silakan screenshot sebagai alternatif.'
        );
      }
      ...
      >
        ...
        >
          ...
          >
            ...
            <h2 className="font-black text-xs tracking-wider uppercase">
              Setoran Berhasil
            </h2>

            <p className="text-[7px] font-bold opacity-70 tracking-widest">
          ...
          {/* Content */}
          <div
            className="p-4 flex-1 space-y-3 bg-[url('https://www.transparenttextures.com/patterns/paper-fibers.png')]"
          ...
          >
            ...
            <div className="space-y-1.5 font-mono">
              <div className="flex justify-between text-[9px] leading-tight">
                ...
                <span
                  className="font-bold text-right truncate ml-2"
                  style={{ color: '#111827' }}
                >
                  {nasabah.nama}
                </span>
            ...
            {photo && (
              <div className="space-y-1 pt-0.5">
                ...
                <div
                  className="w-full h-24 rounded-lg overflow-hidden border shadow-inner"
            ...
            <div className="text-center pt-1.5">
              <p
                className="text-[6px] font-black uppercase tracking-[0.25em]"
                style={{ color: '#9ca3af' }}
              >
        ...
        {/* Zigzag */}
        <div
          className="absolute bottom-0 left-0 right-0 h-1 flex print:hidden overflow-hidden translate-y-full"
          style={{
            backgroundImage:
              'radial-gradient(circle, transparent 70%, #f9fafb 70%)',
